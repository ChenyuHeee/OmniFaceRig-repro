...
| **inner-mouth** | `agent/inner-mouth` | `/opt/dsh/DSH/Cam-ChallengeTrack/agents/inner-mouth` | #2 口腔内部资产 | `code/omnifacerig_repro/inner_mouth.py`、ICT-FaceKit 获取、口腔几何 | done-2026-08-25(PR #8) |
